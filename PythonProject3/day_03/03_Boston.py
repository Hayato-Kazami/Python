...
# 6.模型保存与加载
joblib.dump(model, 'boston_housing_decision_model.pkl')
joblib.dump(transfor, 'boston_housing_decision_transfor.pkl')

# 加载模型和转换器
model_load = joblib.load('boston_housing_decision_model.pkl')
Standard_load = joblib.load('boston_housing_decision_transfor.pkl')
